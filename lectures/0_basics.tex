...
\begin{frame}[fragile]
  ...
  \framesubtitle{Where it all begins.}
	\lstinputlisting[language=C++,title=\lstsrctitle]{code/0_basics/hello_world.cpp}
	\cout{Hello world!}
\end{frame}
...
\begin{frame}[fragile]
 ...
 \lstinputlisting[language=C++,title=\lstsrctitle]{code/0_basics/force_calc.cpp}
 Pretty easy, right?
\end{frame}
...
Spot the difference:
 \lstinputlisting[language=C++,basicstyle=\ttfamily\fontsize{6}{7}\selectfont,title=\lstsrctitle]{code/0_basics/force_calc_const.cpp}
 \pause
...
\begin{frame}[fragile]
  ...
  \lstinputlisting[language=C++,title=\lstsrctitle]{code/0_basics/complete_example.cpp}
\end{frame}